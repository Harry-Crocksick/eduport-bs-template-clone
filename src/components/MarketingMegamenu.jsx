...
export default function MarketingMegamenu() {
    return (
        <nav className="w-[650px] 2xl:w-[992px] group-hover/market:block hidden absolute left-full -top-14 bg-white ring-1 ring-slate-900/5 rounded-lg shadow-lg dark:bg-[#222] overflow-hidden z-[9999]">
